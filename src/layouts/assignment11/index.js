                ...
                <MDBox mt={5} mb={3}>
                    <Grid container spacing={1}>
                        <Grid item xs={18} md={12} xl={6} sx={{ display: "flex" }}>
                            ...
                            <ProfileInfoCard
                                title="Assignment 11: Advisor Assesments"
                                description="Every team is required to obtain an assessment from their project faculty advisor."
                                info={{
                                    dueDate: "11/20/2022",
                                }}
                        ...
                        <Grid item xs={21} md={14} xl={7} sx={{ display: "flex" }}>
                            <Divider orientation="vertical" sx={{ ml: 1, mr: 1 }} />
                            <ProfileInfoCard
                                title="Advisor Assesment Deliverables:"
                                description=""
                                info={{
                                    1: " Please have your project advisor complete the judging rubric located in the syllabus. "
                                }}
