...
import GradeHistory from "layouts/SeniorDesign/components/GradeHistory";
      ...
      <MDBox pt={3} pb={2} px={2}>
        ...
        >
          <GradeHistory
            color="success"
            icon="expand_less"
            name="Assignment #7 - Project Constraints"
            description="23 October 2022"
            value="100/100"
          />
          <MDBox mt={1} mb={2}>
            <MDTypography variant="caption" color="text" fontWeight="bold" textTransform="uppercase">
          ...
          <GradeHistory
            color="success"
            icon="expand_less"
            name="Assignment #6 - Milestones, Timeline, Effort Matrix"
